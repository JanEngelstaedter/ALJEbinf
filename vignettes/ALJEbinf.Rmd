...
# Note: To knit this vignette locally, replace "./extdata/" paths with ""./extdata/"
...
library(dplyr)
library(ALJEbinf)
seqs <- readDNAStringSet("./extdata/rpoB_references.fasta")
seqs
```
...
```{r, echo = FALSE, message = FALSE}
muts <- readr::read_csv("./extdata/mutations.csv",
...
```{r, echo = FALSE, message = FALSE}
refs <- readr::read_csv("./extdata/reference_sequences.csv")
```
...
```{r, echo = FALSE, message = FALSE}
sampleKey <- readr::read_csv("./extdata/sample_key.csv",
                             col_types = readr::cols(.default = "c"))
...
```{r, echo=FALSE}
variants <- callSangerVariants_fasta(sampleKey_file = "./extdata/sample_key.csv",
                                     fasta_path = "./extdata/",
                                     reference_files = "./extdata/rpoB_references.fasta")
```
